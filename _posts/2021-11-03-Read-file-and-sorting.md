...
layout: post
post-image: /assets/images/fileIO.jpg
description: How to read a datafile and sorting
tags:
- C#/.NET
- File I/O
- Bubble Sort
...
This article will show you how to read text files and sort data from them.
There are several methods for aligning data, however solutions by using Bubble Sort and List's Sort() method were described.

# The approch the Bubble Sort
